package ru.practicum.exploreWithMe.stats.categories.controller.accessible;
...
public class PublicCategoriesController {
    ...
    public List<CategoryDto> getAll(
        ...
        List<CategoryDto> categoryResponse = service.getAll(from, size);
    ...
    public CategoryDto get(
        ...
        CategoryDto categoryResponse = service.get(catId);
